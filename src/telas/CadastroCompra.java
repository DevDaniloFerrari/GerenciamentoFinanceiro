...
public class CadastroCompra extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jLabel7.setText("A partir do mês:");
    ...
    private void btn_concluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_concluirActionPerformed
        if(txt_nome.getText().isEmpty()){
            JOptionPane.showMessageDialog(null,"O campo de nome não\npode estar vazio!","Aviso",2);
        }else{
            ...
            //if(){
                ...
                /*
                    ...
                    !!!! Cadastro no Banco está funcionando !!!!

                    !!!! Lógica para Vezes de Pagamento !!!!

                    !!!! Pensar em uma chave identificadora para compra, independete das vezes !!!!

                    !!!! Implementar programação para calcular Juros !!!!

                    !!!! Programar as Validações necessárias para cadastro de compra !!!!
                    ...
                    > Validar Criação de Cartão

                    > Mostrar Cartão criado sem ter que logar Novamente
